...
3. On the Windows desktop, click **Start**, type **Microsoft SQL Server Management Studio**, and then press Enter.
4. In the **Connect to Server** dialog box, log on to **LON-SQLR** using Windows authentication.
...
8. In **Object Explorer**, right-click **LON-SQLR**, and then click **Restart**.
...
12. In **Object Explorer**, expand **LON-SQLR**, right-click **Databases**, and then click **New Database**.
13. In the **New Database** dialog box, in the **Database name** text box, type **FlightDelays**, and then click **OK**.
14. Leave SQL Server Management Studio open.
